...
//
/* mi codigo propio en preparacion sin el equipo
import {traverse} from '../1linked/2/together.js'
//MY BINARY TREE
let root = {
  d : "*",
  l: null,
...
traverse(root)
*/
/* ---------- CODIGO EN EQUIPO          INTEGRANTES:          -- Vazquez Montes Alberto David, -- Rios Estrella Edwin Isai, --Pandur Raul Roberto, --Alvarez Sanches Hector Antonio*/
class Node {
  constructor (value) {
    this.value = value
    this.right = null
